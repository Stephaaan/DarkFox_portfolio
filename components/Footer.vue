<template>
  <div class="flex-flex-col bg-paperWhite">
    <div class="w-full flex justify-center mb-4">
      <img src="~/assets/images/facebook.svg" alt="fb" class="mx-8 md:mx-32 w-5 md:w-8">
    ...
    >
      <p>
        ...
        <font class="text-dfOrange pl-1 md:pl-2">DarkFox software</font>
      </p>
